...
const Contact = (props) => {
  return (
    <div className="contact-container">
      <Helmet>
        <title>Contact - Christian Detailing</title>
        <meta property="og:title" content="Contact - Christian Detailing" />
      </Helmet>
      <header data-thq="thq-navbar" className="contact-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="contact-desktop-menu">
          <nav className="contact-links1">
            ...
            <Link to="/pricing" className="contact-navlink4">
              Pricing
            </Link>
          </nav>
          <div className="contact-buttons1"></div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="contact-mobile-menu">
          <div className="contact-nav">
            ...
            <nav className="contact-links2">
              <span className="contact-text1">About</span>
              <span className="contact-text2">Features</span>
              <span className="contact-text3">Pricing</span>
              <span className="contact-text4">Team</span>
              <span className="contact-text5">Blog</span>
            </nav>
