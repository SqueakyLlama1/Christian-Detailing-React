  ...
  return (
    <div className="home-container">
      <Helmet>
        ...
        <meta property="og:title" content="Christian Detailing" />
      </Helmet>
      ...
      <h1 className="home-text6">Christian Detailing</h1>
      <span className="home-text7">
        Hi, I&apos;m Christian. I&apos;m 14, and I run a small local detailing
        business in Taylorsville and Murray. If you are curious about my working
        range, it is roughly in the area shown by the image below. If you are
        out of range, contact me and I may still consider detailing your
        vehicle.
      </span>
      <img
        alt="image"
        src="https://www.christiandetailing.com/img/range.png"
